...
const Header = () => {
  ...
  return (
    <>
            ...
            <div className="navbar-start">
              <div className="dropdown">
                ...
                <ul
                  ...
                  <Link to="/">
                    <li className="text-black text-[14px] font-display-dm opacity-70 hover:text-hoverC hover:font-bold hover:opacity-100">
                      Home
                    </li>
                  </Link>
                  <Link to="/shop">
      ...
      <div className={" py-[25px] bg-categoryBg relative"}>
        <Container>
          <Flex className={"justify-between items-center"}>
            <div className="flex items-center gap-x-3">
              <div className="flex items-center" onClick={()=>setdrop(!drop)}>
                <Bars />
              ...
              <div className="bg-red-800 rounded-xl list-none p-4 absolute left-[90px] bottom-[-95px] z-10">
                  ...
                  <Link to="/">
                    <li className="text-white text-[14px] font-display-dm opacity-70 hover:text-hoverC hover:font-bold hover:opacity-100">
                      Home
                    </li>
                  </Link>
                  <Link to="/shop">
            ...
            <div className="relative">
              <input
                ...
                className="bg-white text-normal p-5 w-[600px] border rounded-xl border-categoryBg"
              />
